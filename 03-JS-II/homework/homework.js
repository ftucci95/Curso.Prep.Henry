...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (num1<0 || num2<0 || num3<0) devolver= "Hay negativos";
  else if (num1 == 0 || num2 ==0 || num3==0) devolver="Error";
  else if(num1>num2 && num1>num3 && num1>0) devolver="Número 1 es mayor y positivo";
  else if (num3>num2 && num3>num1) devolver=num3+1;
  else return false
  return devolver;
}
